...
if (data.method == "pushMessage") { console.log("Push notification sent");
 ...
 event.waitUntil(self.registration.showNotification("VarunM Portfolio", { body: data.message
})) }
} })
var filesToCache = [ '/',
'/', '/index.html', '1.png', 'Varun.png', 'yellowsq.gif'
];
...
return cache.match("index.html"); } else {
return matching; }
});
});
};